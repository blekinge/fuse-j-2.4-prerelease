...
static int javafs_getattr(const char *path, struct stat *stbuf)
{
   ...
   while (1)
   {
      ...
      jGetattr = (*env)->NewObject(env, FuseGetattr->class, FuseGetattr->constructor.new__V);
      if (exception_check_jerrno(env, &jerrno)) break;

      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.getattr__Ljava_nio_ByteBuffer_Lfuse_FuseGetattrSetter___I, jPath, jGetattr);
      if (exception_check_jerrno(env, &jerrno)) break;
...
static int javafs_readlink(const char *path, char *buf, size_t size)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.readlink__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer___I, jPath, jLink);
      if (exception_check_jerrno(env, &jerrno)) break;

      // write a cstring terminator at the end of writen data
      jLinkPosition = (*env)->CallIntMethod(env, jLink, ByteBuffer->method.position__I);
      if (exception_check_jerrno(env, &jerrno)) break;
      buf[jLinkPosition] = '\0';
...
static int javafs_getdir(const char *path, fuse_dirh_t h, fuse_dirfil_t filler)
{
   ...
   while (1)
   {
      ...
      jDirEntList = (*env)->NewObject(env, FuseFSDirFiller->class, FuseFSDirFiller->constructor.new__V);
      if (exception_check_jerrno(env, &jerrno)) break;

      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.getdir__Ljava_nio_ByteBuffer_Lfuse_FuseFSDirFiller___I, jPath, jDirEntList);
      if (exception_check_jerrno(env, &jerrno)) break;

      n = (*env)->CallIntMethod(env, jDirEntList, FuseFSDirFiller->method.size__I);
      if (exception_check_jerrno(env, &jerrno)) break;
      ...
      for (i = 0; i < n; i++)
      {
         ...
         jDirEnt = (*env)->CallObjectMethod(env, jDirEntList, FuseFSDirFiller->method.get__I__Ljava_lang_Object_, i);
         if (exception_check_jerrno(env, &jerrno)) break;
...
static int javafs_mknod(const char *path, mode_t mode, dev_t rdev)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.mknod__Ljava_nio_ByteBuffer_II__I, jPath, (jint)mode, (jint)rdev);
...
static int javafs_mkdir(const char *path, mode_t mode)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.mkdir__Ljava_nio_ByteBuffer_I__I, jPath, (jint)mode);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_unlink(const char *path)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.unlink__Ljava_nio_ByteBuffer___I, jPath);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_rmdir(const char *path)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.rmdir__Ljava_nio_ByteBuffer___I, jPath);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_symlink(const char *from, const char *to)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.symlink__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer___I, jFrom, jTo);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_rename(const char *from, const char *to)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.rename__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer___I, jFrom, jTo);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_link(const char *from, const char *to)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.link__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer___I, jFrom, jTo);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_chmod(const char *path, mode_t mode)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.chmod__Ljava_nio_ByteBuffer_I__I, jPath, (jint)mode);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_chown(const char *path, uid_t uid, gid_t gid)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.chown__Ljava_nio_ByteBuffer_II__I, jPath, (jint)uid, (jint)gid);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_truncate(const char *path, off_t size)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.truncate__Ljava_nio_ByteBuffer_J__I, jPath, (jlong)size);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_utime(const char *path, struct utimbuf *buf)
{
   ...
   while (1)
   {
      ...
      (*env)->CallVoidMethod(env, fuseFS, FuseFS->method.utime__Ljava_nio_ByteBuffer_II__I, jPath, (jint)(buf->actime), (jint)(buf->modtime));
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_open(const char *path, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jOpen = (*env)->NewObject(env, FuseOpen->class, FuseOpen->constructor.new__V);
      if (exception_check_jerrno(env, &jerrno)) break;
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.open__Ljava_nio_ByteBuffer_ILfuse_FuseOpenSetter___I, jPath, (jint)(ffi->flags), jOpen);
      if (exception_check_jerrno(env, &jerrno)) break;
      ...
      ffi->fh = (unsigned long) jFhGlobalRef;
...
static int javafs_read(const char *path, char *buf, size_t size, off_t offset, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.read__Ljava_nio_ByteBuffer_Ljava_lang_Object_Ljava_nio_ByteBuffer_J__I, jPath, (jobject) (ffi->fh), jBuf, (jlong)offset);
      if (exception_check_jerrno(env, &jerrno)) break;

      // to obtain # of bytes read, get current position from ByteBuffer
      nread = (*env)->CallIntMethod(env, jBuf, ByteBuffer->method.position__I);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_write(const char *path, const char *buf, size_t size, off_t offset, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.write__Ljava_nio_ByteBuffer_Ljava_lang_Object_ZLjava_nio_ByteBuffer_J__I, jPath, (jobject) (ffi->fh), (ffi->writepage)? JNI_TRUE : JNI_FALSE, jBuf, (jlong)offset);
      if (exception_check_jerrno(env, &jerrno)) break;

      // to obtain # of bytes writen, get current position from ByteBuffer
      nwriten = (*env)->CallIntMethod(env, jBuf, ByteBuffer->method.position__I);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_statfs(const char *path, struct statfs *fst)
{
   ...
   while (1)
   {
      jStatfs = (*env)->NewObject(env, FuseStatfs->class, FuseStatfs->constructor.new__V);
      if (exception_check_jerrno(env, &jerrno)) break;

      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.statfs__Lfuse_FuseStatfsSetter___I, jStatfs);
      if (exception_check_jerrno(env, &jerrno)) break;
...
static int javafs_flush(const char *path, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.flush__Ljava_nio_ByteBuffer_Ljava_lang_Object___I, jPath, (jobject) (ffi->fh));
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_release(const char *path, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.release__Ljava_nio_ByteBuffer_Ljava_lang_Object_I__I, jPath, jFh, (jint)(ffi->flags));
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_fsync(const char *path, int datasync, struct fuse_file_info *ffi)
{
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.fsync__Ljava_nio_ByteBuffer_Ljava_lang_Object_Z__I, jPath, (jobject) (ffi->fh), (jint)(ffi->flags), datasync? JNI_TRUE : JNI_FALSE);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_setxattr(const char *path, const char *name, const char *value, size_t size, int flags)
{
   ...
   while(1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.setxattr__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_I__I, jPath, jName, jValue, (jint)flags);
      exception_check_jerrno(env, &jerrno);
      break;
   }
...
static int javafs_getxattr(const char *path, const char *name, char *value, size_t size)
{
   ...
   while (1)
   {
      ...
      if (size == 0)
      {
         jSize = (*env)->NewObject(env, FuseSize->class, FuseSize->constructor.new__V);
         if (exception_check_jerrno(env, &jerrno)) break;

         jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.getxattrsize__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_Lfuse_FuseSizeSetter___I, jPath, jName, jSize);
         if (exception_check_jerrno(env, &jerrno)) break;
      ...
      else
      {
         ...
         jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.getxattr__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer___I, jPath, jName, jValue);
         if (exception_check_jerrno(env, &jerrno)) break;

         // to obtain # of bytes read, get current position from ByteBuffer
         xattrsize = (*env)->CallIntMethod(env, jValue, ByteBuffer->method.position__I);
      }
...
static int javafs_listxattr(const char *path, char *list, size_t size)
{
   ...
   while (1)
   {
      ...
      if (size == 0)
      {
         ...
         jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.listxattrsize__Ljava_nio_ByteBuffer_Lfuse_FuseSizeSetter___I, jPath, jSize);
         if (exception_check_jerrno(env, &jerrno)) break;
      ...
      else
      {
         ...
         jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.listxattr__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer___I, jPath, jList);
         if (exception_check_jerrno(env, &jerrno)) break;

         // to obtain # of bytes read, get current position from ByteBuffer
         xattrsize = (*env)->CallIntMethod(env, jList, ByteBuffer->method.position__I);
      }
...
static int javafs_removexattr(const char *path, char *name)
{
   JNIEnv *env = get_env();
   jobject jPath = NULL;
   jobject jName = NULL;
   ...
   while (1)
   {
      ...
      jerrno = (*env)->CallIntMethod(env, fuseFS, FuseFS->method.removexattr__Ljava_nio_ByteBuffer_Ljava_nio_ByteBuffer___I, jPath, jName);
      exception_check_jerrno(env, &jerrno);
      break;
   }
